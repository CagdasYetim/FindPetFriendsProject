...
export class ProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.checkboxTaskController = {
      ...
      color: 'primary',
      subtasks: [
        {name: 'Show my Name', completed: false, color: 'primary'},
        {name: 'Show my last Location', completed: false, color: 'primary'},
        {name: 'send me notification',completed:false,color :'primary'}
      ]
    };
  ...
  addEnjoyToMeResults(object:string){
